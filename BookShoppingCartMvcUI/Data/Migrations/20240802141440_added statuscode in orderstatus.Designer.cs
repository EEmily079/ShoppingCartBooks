...
namespace BookShoppingCartMvcUI.Data.Migrations
{
    ...
    [Migration("20240802141440_added statuscode in orderstatus")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.Order", b =>
                {
                    ...
                    b.Property<int>("orderStatusIdId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("orderStatusIdId");
            ...
            modelBuilder.Entity("BookShoppingCartMvcUI.Models.Order", b =>
                {
                    b.HasOne("BookShoppingCartMvcUI.Models.OrderStatus", "orderStatusId")
                        .WithMany()
                        .HasForeignKey("orderStatusIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
